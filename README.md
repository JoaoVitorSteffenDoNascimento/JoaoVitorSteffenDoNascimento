...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=210&section=header&text=Jo%C3%A3o%20Vitor%20Steffen&fontSize=48&fontColor=ffffff&fontAlignY=36&desc=Software%20Engineer%20%7C%20Co-Founder%20%40%20GuardianDocs%20%7C%20Cybersecurity&descAlignY=56&descColor=a78bfa&animation=fadeIn" width="100%"/>
...
### 🥇 CourseMapper — 1º Lugar, Hackathon Feevale University *(Mar 2026)*
Plataforma acadêmica full-stack para planejamento de cursos, visualização de pré-requisitos e currículos.

- **Frontend:** React + Vite com autenticação, dashboards e visualização interativa de currículo
- **AI Integration:** Mistral AI para parsing automático de PDFs/DOCXs
- **Performance:** Otimização do backend Node.js + Express + PostgreSQL — latência reduzida **94%** (de 3–4s para ~200ms / **15× mais rápido**)
- **Deploy:** Render, Vercel e GitHub Pages

### 🎮 TryHardHub — TCC em Desenvolvimento *(IFSUL)*
Plataforma competitiva de matchmaking, formação de times e rating de jogadores.
